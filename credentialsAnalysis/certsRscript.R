...
file2015_01 <- "Certs Text Files/Certs 2015/Certs 2015-01.txt"
...
file01 <- read.delim('Certs Text Files/Certs 2015/Certs 2015-01.txt')

## Main 2015
main2015.01 <- msaFilter(read.delim(file2015_01))
